...
def parse_opt():
    ...
    parser.add_argument('--train_student', type=bool, default=True, help="train student model")
    parser.add_argument('--compare_to_mlp', type=bool, default=False, help="train basic mlp")

    # student model settings
    parser.add_argument('--hidden_size', type=int, default=128 * 1, help="hidden size for student")
    ...
    # split dataset
    parser.add_argument('--split', type=bool, default=True, help="re group the dataset")
