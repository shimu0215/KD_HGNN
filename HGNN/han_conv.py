...
class HANConv(MessagePassing):
    ...
    def forward(
        ...
        return_metapath_level_embedding: bool = False,
        ...
        # iterate over node types:
        semantic_attn_dict = {}
        metapath_level_embedding = {}
        for node_type, outs in out_dict.items():
            out, attn = group(outs, self.q, self.k_lin)
            out_dict[node_type] = out
            semantic_attn_dict[node_type] = attn
            metapath_level_embedding[node_type] = outs

        if return_metapath_level_embedding:
            return out_dict, semantic_attn_dict, metapath_level_embedding
